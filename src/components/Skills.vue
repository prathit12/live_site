     ...
     <section id="skills">
            <div class="container">
                ...
                <div class="integration-list row justify-content-center py-5">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/react.svg" alt="php">
                        <p class="skill-label">ReactJS</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/java.svg" alt="vuejs">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/mongodb.svg" alt="mysql">
                    ...
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/Jenkins.svg" alt="docker">
                        <p class="skill-label">Jenkins</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/Django.svg" alt="javascript">
                        <p class="skill-label">Django</p>
                    </div>
                    <div class="item col-4 col-md-3 col-lg-2 mb-3 mb-lg-5 bottom-line-lg">
                        <img class="shadow rounded-circle"  src="@/assets/img/skills/Flask.svg" alt="javascript">
